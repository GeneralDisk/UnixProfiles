...
"      The following command will remove all shmem, flutter, and profiler log
"      lines note the double escape since vimrc requires an escape \ for |
nnoremap <f4> :%!grep -v "flut\\|shmem\\|profiler"<return>
