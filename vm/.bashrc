...
# Add git branch to the PS1 line
## To do this, add a function to query the git branch, then we'll add it to the PS1
# You can change around the positioning, but you'll have to remove the \$ from the PS1 lines above
# to get a proper root rep
git_branch() {
        git branch 2> /dev/null | sed -e '/^[^*]/d' -e 's/* \(.*\)/ (\1)/'
}
PS1='\e[0;35m$(git_branch)\e[m '$PS1
